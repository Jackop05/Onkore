    ...
    return (
      <div className="w-screen h-screen flex flex-col justify-center basic bg-slate-50">
        <div className="flex gap-24 justify-center">
            <div className="w-[400px] h-[500px] rounded-[20px] shadow-xl flex flex-col justify-between px-8 py-12 bg-white cursor-default">
            ...
            <div className="w-[400px] h-[500px] rounded-[20px] shadow-xl flex flex-col justify-between px-8 py-12 bg-white cursor-default">
                ...
                <button
                type="submit"
                className="w-full text-white py-2 rounded-lg bg-neonblue shadow-sm transition-all duration-150 hover:scale-105"
                >
